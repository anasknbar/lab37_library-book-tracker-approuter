...
<div className="container mx-auto px-4 py-16" id="books-target-section">
  <h2 className="text-2xl font-bold tracking-tight text-gray-900 mb-8">Book Collection</h2>
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
    { sortedBooks.map((book, index) => {
      return (
        <div className="bg-white rounded-md shadow-md overflow-hidden" key={index}>
