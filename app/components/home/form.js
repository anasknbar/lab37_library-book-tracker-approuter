  ...
  return (
    <>
      <div
        ...
        className=" p-8 rounded border border-gray-200 mt-48"
      >
          ...
          <div className="mt-8 grid lg:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <textarea
                ...
                name="description"
                rows="4"
                className="block p-2.5 w-full rounded text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-100 dark:border-gray-200 dark:placeholder-gray-400 dark:text-gray-700 dark:focus:ring-blue-500 dark:focus:border-blue-500"
